...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4elo3aa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4elo3aa.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jovanykoch/container-4elo3aa.git
cd container-4elo3aa
```
...
```
docker attach container-4elo3aa
```
